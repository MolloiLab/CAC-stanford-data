...
if ~isdir(string(cd(pwd, "..") , "/data/output/", VENDER, "_agatston_mass_score_script"))
	mkdir(string(cd(pwd, "..") , "/data/output/", VENDER, "_agatston_mass_score_script",))
end

# ╔═╡ 09b33976-a24e-4bd7-b8a6-7fc47efb6f94
output_path = string(cd(pwd, "..") , "/data/output/", VENDER, "_agatston_mass_score_script", "/output.csv")
